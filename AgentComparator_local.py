...
def _deviz_key(art: dict) -> str:
    ...
    NOTE: deviz_key field (3-layer Sub-project B) is stored on articles as metadata
    but NOT used for matching — ref and oferta may extract different text for the
    same deviz due to OCR variations, producing different keys and breaking matching.
    """
